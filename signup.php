...
$db['user'] = "g031o050";  // ユーザー名
$db['pass'] = "g031o050";  // ユーザー名のパスワード
$db['dbname'] = "g031o050";  // データベース名
...
if (isset($_POST["signUp"])) {
    ...
    if (!empty($_POST["username"]) && !empty($_POST["password"]) && !empty($_POST["password2"]) && $_POST["password"] === $_POST["password2"]) {
        ...
        try {
            ...
            $signUpMessage = '登録が完了しました。あなたの登録ユーザー名は '. $username. ' です。パスワードは '. $password. ' です。';  // ログイン時に使用するIDとパスワード
